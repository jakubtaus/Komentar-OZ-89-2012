...
Tato kapitola pokrývá zbytek úpravy nabývání vlastnictví a klíčový institut **spoluvlastnictví** vč. **bytového spoluvlastnictví** (SVJ).

| Pododdíl / Oddíl | Paragrafy | Téma |
|---|---|---|
| Pododdíl 5 (pokr.) | § 1091—1098 | **Vydržení** (lhůty, mimořádné vydržení) |
| Pododdíl 6 | § 1099—1108 | **Převod vlastnického práva** |
| Pododdíl 7 | § 1109—1113 | **Nabytí od neoprávněného** |
| Pododdíl 8 | § 1114 | Nabytí rozhodnutím orgánu VM |
| Díl 4 Oddíl 1—4 | § 1115—1157 | **Klasické spoluvlastnictví** (správa, zrušení) |
| Díl 4 Oddíl 5 | § 1158—1222 | **Bytové spoluvlastnictví, SVJ** |

---

## Dokončení vydržení (§ 1091—1098)
...
**Klasické vydržecí lhůty** (paralela k římskému *usucapio* — 3 / 30 let):
- **Movitá věc: 3 roky**;
- **Nemovitá věc: 10 let**.
...
**Mimořádné vydržení** (*usucapio extraordinaria*) — **bez nutnosti prokázat právní důvod**:
- **Movitá věc: 6 let** (2× 3);
- **Nemovitá věc: 20 let** (2× 10).
...
### § 1099 — Princip převodu samotnou smlouvou
...
**Konsenzuální princip** (*Konsensprinzip*) — vlastnictví přechází **okamžikem účinnosti smlouvy** (typicky uzavřením, ledaže odloženo podmínkou). **Rozdíl od BGB** (Übergabeprinzip — vyžadováno předání) — OZ je blíž **CCQ / francouzskému CC**.

**Výjimky**:
- **Movité věci určené podle druhu** — až oddělením (§ 1101);
...
**Dvojí prodej** (*Doppelverkauf*) — řešení:

| Typ věci | Pravidlo |
|---|---|
| **Movitá** (nezapsaná) | (1) Komu věc vydána nejdříve; (2) jinak komu smlouva uzavřena první |
...
**§ 1103 — Cenné papíry**:
- **Na doručitele**: smlouva + **předání**;
- **Na řad**: smlouva + **rubopis + předání**;
- **Na jméno**: **samotnou smlouvou** k okamžiku účinnosti.

**§ 1104 — Zaknihované CP**: zápis na účet vlastníka (nebo zákazníků).
...
**§ 1107 — Závady**:
- **Zapsané v VR** → vždy přejímá;
- **Jiné závady** → přejímá, **měl-li a mohl-li je zjistit** nebo bylo-li to ujednáno nebo stanoví zákon;
...
## Nabytí od neoprávněného (§ 1109—1113)

**Klíčový institut** ochrany **dobré víry** v obchodním styku. Paralela k německému § 932 BGB, francouzské zásadě *en fait de meubles, possession vaut titre*.

### § 1109 — Šest situací nabytí
...
**Šest situací** nabytí od neoprávněného (dobrá víra **vždy nutná**):

| Písm. | Situace | Příklad |
|---|---|---|
| a) | **Veřejná dražba** | Aukce dle z. č. 26/2000 Sb. |
| b) | **Podnikatel v běžném obchodním styku** | Nákup v obchodě |
| c) | **Za úplatu od svěřené osoby** | Pronajímatel prodal vypůjčenou věc |
| d) | **Neoprávněný dědic** s potvrzeným nabytím | Po prohlášení za mrtvého |
| e) | **Investiční nástroje / CP na doručitele** | Burzovní obchody |
| f) | **Komoditní burza** | |

**Společné rysy:**
- **Věc není zapsána v VR** (pro VR platí § 984);
...
**Speciální pravidlo pro POUŽITÉ věci** (bazary, autobazary):
- Nabyvatel v dobré víře **se NESTAVÁ vlastníkem**, pokud:
  - Vlastník prokáže **ztrátu / svémocné odnětí** (krádež, loupež);
  - **A** od ztráty/odnětí uplynuly **max. 3 roky**.
...
**Zbytková klauzule**: i mimo § 1109—1110 lze nabýt v dobré víře, **kromě**:
- **Ztráta**;
...
- Investiční nástroje, CP na doručitele;
- Veřejnou dražbu;
- Dražbu při výkonu rozhodnutí / exekuci;
- Komoditní burzu.
...
Soud / správní orgán → nabytí **k dni určenému** nebo (default) **dnem právní moci**. Typické případy:
- Soudní vypořádání spoluvlastnictví (§ 1147);
- Vyvlastnění;
...
**§ 1122 — Velikost podílu**:
- Vyplývá z **právní skutečnosti** (zakládající spoluvlastnictví);
- **Ujednání spoluvlastníků** možné (s náležitostmi pro převod podílu);
...
- **Bezúplatný převod**: spoluvlastníci vykoupí za **obvyklou cenu**;
- **Výjimka**: spoluvlastník převádí jinému spoluvlastníku / manželu / sourozenci / příbuznému v řadě přímé.
...
**§ 1127 — Solidární zavázanost a oprávněnost** ze správních jednání.

**§ 1128 — BĚŽNÁ SPRÁVA**: **většinou hlasů**. Účinky **jen při informování všech** (jinak opominutý spoluvlastník může do **30 dnů** napadnout u soudu — § 1128/3).

**§ 1129 — VÝZNAMNÁ ZÁLEŽITOST** (podstatné zlepšení/zhoršení, změna účelu, zpracování): **2/3 většina** hlasů; nedosáhne-li se → soud. Přehlasovaný spoluvlastník může navrhnout **soudní přezkum**.

**§ 1130 — Ochrana přehlasovaného před těžkou újmou**: může navrhnout **zrušení rozhodnutí** soudem.

**§ 1131**: většina může se zavázat, že přehlasovaný nemusí přispívat nebo dostane plnou náhradu škody + jistotu → ztrácí právo § 1130.

**§ 1132 — JEDNOMYSLNOST**: nutná pro:
- **Zatížení** společné věci / zrušení zatížení;
- **Omezení práv spoluvlastníků** na dobu **> 10 let**.

**§ 1133**: 2/3 většina stačí pro **zástavu k zajištění pohledávky** ze zlepšení / obnovy.
...
1. **Rozdělení** věci;
2. **Prodej** z volné ruky / veřejnou dražbou + rozdělení výtěžku;
3. **Převedení** jednomu spoluvlastníkovi s vyplacením ostatních.

**§ 1142 — Vyloučení dělení**:
- Věc, která **má sloužit jako celek**;
- **Zemědělský pozemek** — jen účelně obdělávatelné díly (s výjimkou stavby / vyvlastnění).

**§ 1143 — Soudní zrušení** při neshodě.

**§ 1144 — Rozdělení soudem**: pokud snížení hodnoty není podstatné; rozdíly se vyrovnají **v penězích**.

**§ 1147 — Přikázání**: nelze-li dělit → soud **přikáže za přiměřenou náhradu** jednomu/více spoluvlastníkům; pokud nechce nikdo → **veřejná dražba** (lze omezit jen na spoluvlastníky).

**§ 1148 — Vypořádání dluhů**: souvisejí-li se spoluvlastnictvím / společnou věcí.
...
**§ 1151—1153**: úprava věcných břemen při rozdělení.

**§ 1154 — Odklad zrušení**:
- Smluvně **až 10 let**;
- Opakovaně možné;
- Pro nástupce — výslovné ujednání;
- **Forma veřejné listiny** + zápis do VR.
...
**Bytové spoluvlastnictví** — specifický **hybridní institut**: vlastnictví **jednotky** (bytu) + **podíl na společných částech**. Klíčový pro **bytové domy s SVJ** (Společenství vlastníků jednotek). Nahrazuje zrušený **zákon č. 72/1994 Sb.**
...
**§ 1165 — Rozhodnutím soudu** (při oddělení / zrušení spoluvlastnictví, vypořádání SJM).

**§ 1166 — Prohlášení vlastníka**: pozemek + dům + jednotky + společné části + velikost podílů + věcná práva. **Příloha**: půdorysy podlaží + údaje o podlahových plochách.

**§ 1167**: po zápisu **nelze prohlašovat za neplatné** (pokud jednotku již nabyla další osoba).
...
- **Stavební úpravy uvnitř**;
- **Zákaz ztížit** jinému vlastníku výkon stejných práv;
- **Zákaz ohrozit / poškodit** společné části.

**§ 1175 odst. 2**: údržba bytu vlastníkem; **drobné opravy společných částí** uvnitř bytu (resp. v jeho výlučném užívání) hradí vlastník.

**§ 1176**: vlastník se musí **řídit pravidly správy domu**.

**§ 1177**: oznámení správci jména, bydliště, počet osob v bytě.

**§ 1180 — Příspěvek na správu**:
- **Default**: **poměr podílu** na společných částech;
- **Příspěvky na administrativu / účetnictví / odměny**: **na každou jednotku stejně**.
...
**§ 1189—1193 — Pravidla správy**, fond oprav, hlasování o opravách.

**§ 1194 a násl. — SPOLEČENSTVÍ VLASTNÍKŮ JEDNOTEK (SVJ)** — povinné při počtu **alespoň 5 jednotek** a alespoň **4 vlastnících** (různých). Má právní subjektivitu (PO sui generis).

**§ 1206 — Shromáždění**: 1× ročně; pozvánka **30 dnů předem**.
...
Kapitola 18 představuje **klíčové instituty nabývání vlastnictví** a **spoluvlastnictví** vč. bytového.

**Klíčové instituty:**

1. **VYDRŽENÍ** (§ 1091—1098):
   - **Movité 3 roky / nemovité 10 let** (řádné);
   - **MIMOŘÁDNÉ VYDRŽENÍ** (§ 1095): **6 / 20 let bez nutnosti prokázat titul** (kromě prokázaného nepoctivého úmyslu);
   - Přerušení po 1 roce nevykonávání;
   - Stavění mezi manžely / v společné domácnosti / zástupce-zastoupený;
2. **PŘEVOD vlastnictví** (§ 1099—1108):
   - **Konsenzuální princip** — okamžikem účinnosti smlouvy (pro jednotlivě určené věci);
   - Druhové věci — oddělením;
   - Nemovitosti — **konstitutivní zápis do KN** (§ 1105);
   - CP — podle typu (předání, rubopis, smlouva);
   - **Dvojí prodej** (§ 1100) — u movitých prvenství vydáním nebo smlouvou; u nemovitostí **prvenství zápisu v dobré víře**;
   - **Závady na věci** (§ 1107) — zapsané vždy, jiné při možné znalosti / ujednání / zákonu; nepřejaté zanikají;
3. **NABYTÍ OD NEOPRÁVNĚNÉHO** (§ 1109—1113):
   - **6 situací** § 1109: veřejná dražba, podnikatel v běžném styku, věc svěřená, neoprávněný dědic, CP na doručitele, komoditní burza;
   - **Vždy dobrá víra + řádný titul + věc nezapsaná v VR**;
   - **§ 1110 — POUŽITÉ VĚCI** — vlastník vindikuje při ztrátě/odnětí + max. 3 roky;
   - **§ 1111** — mimo § 1109/1110 jen dobrá víra (vlastník vindikuje při ztrátě/úmyslném TČ);
   - **§ 1112** — vyloučení obrany dobrou vírou předchůdce při vědomé znalosti;
   - **§ 1113** — silnější ochrana u CP na doručitele a dražebních / burzovních nabytí;
4. **Nabytí rozhodnutím orgánu VM** (§ 1114);
5. **SPOLUVLASTNICTVÍ** (§ 1115—1157):
   - **Každý úplným vlastníkem podílu** (§ 1121);
   - **Domněnka stejných podílů** (§ 1122);
   - **PŘEDKUPNÍ PRÁVO** (§ 1124) — jen u spoluvlastnictví **vzniklého bez vlivu** stran (smrt, jiná skutečnost), **6 měsíců** od vzniku; výjimky pro převody blízkým; bezúplatný převod — výkup za obvyklou cenu;
   - **SPRÁVA**: § 1128 běžná **většinou hlasů** (s informováním všech), § 1129 významná **2/3 většina**, § 1132 **jednomyslnost** pro zatížení / omezení > 10 let;
   - **Ochrana přehlasovaného** před těžkou újmou (§ 1130) — soud zruší rozhodnutí;
   - **NIKDO NEMŮŽE BÝT NUCEN setrvat** (§ 1140); ne v nevhodnou dobu / k újmě jiných;
   - **3 způsoby vypořádání** (§ 1141): rozdělení / prodej / přikázání s vyplacením;
   - Soudní odklad zrušení max. **2 roky** (§ 1155); smluvní **až 10 let**;
6. **BYTOVÉ SPOLUVLASTNICTVÍ** (§ 1158—1222):
   - Jednotka = byt + podíl na společných částech;
   - Vznik: **výstavbou / zápisem do VR / rozhodnutím soudu**;
   - **Prohlášení vlastníka** (§ 1166) — náležitosti + půdorysy;
   - **Velikost podílů**: default poměr **podlahové plochy**;
   - **Příspěvek na správu**: poměr podílu; administrativa stejně na každou jednotku;
   - **SVJ** (§ 1194 a násl.) — povinné při **≥ 5 jednotkách + 4 různých vlastnících**; právní subjektivita;
   - **Shromáždění SVJ** — 1× ročně, pozvánka 30 dnů; rozhoduje o stanovách, příspěvcích, opravách, volbě výboru;
   - **Přehlasovaný vlastník** — 3 měsíce na soudní napadení.

---

> Konec kapitoly 18. Pokračování: kapitola 19 — Hlava II Díl 5—7 (§ 1240—1399): Věcná práva k cizí věci — právo stavby, věcná břemena, zástavní právo, zadržovací právo.
