# Kapitola 25 — Část čtvrtá, Hlava II, Díl 2—4: Licence, zápůjčka, úvěr, úschova, účet, akreditiv, příkazní smlouvy (příkaz, zprostředkování, komise), dílo, péče o zdraví, zájezd (§ 2358—2654)

## Přehled

Tato kapitola pokrývá **široké spektrum smluvních typů** — od **licence** (užívání nehmotných statků) přes **finanční smlouvy** (zápůjčka, úvěr, účet, akreditiv) až po **smlouvy o činnosti pro jiného** (příkaz, dílo, péče o zdraví).

| Smlouva | Paragrafy | Charakter |
|---|---|---|
| **Licence** | § 2358—2389 | Užívání nehmotného statku |
| **Zápůjčka** | § 2390—2394 | Půjčka peněz / zastupitelných věcí |
| **Úvěr** | § 2395—2400 | Smluvní úvěr |
| **Smlouva o úschově** | § 2402—2408 | Schování věci pro jiného |
| **Smlouva o skladování** | § 2415—2429 | Podnikatelská úschova |
| **Smlouva o účtu** | § 2662—2675 (přeřazeno) | Bankovní účet |
| **Smlouva o jednorázovém vkladu** | § 2680—2683 | Termínovaný vklad |
| **Akreditiv** | § 2682—2693 | Bankovní akreditiv |
| **Příkaz** | § 2430—2444 | Obstarání záležitosti pro jiného |
| **Zprostředkování** | § 2445—2454 | Příležitost k uzavření smlouvy |
| **Komise** | § 2455—2470 | Komisionář vlastním jménem na účet komitenta |
| **Zasílatelská smlouva** | § 2471—2482 | Obstarání přepravy |
| **Smlouva o obchodním zastoupení** | § 2483—2520 | Obchodní zástupce |
| **Smlouva o tichém společenství** | § 2747—2755 | Vklad bez veřejné účasti |
| **Smlouva o péči o zdraví** | § 2636—2651 | Lékař × pacient |
| **Jednatelství bez příkazu** | § 3006—3014 (V. část) | Negotiorum gestio |
| **Smlouva o dílo** | § 2586—2635 | Zhotovení / provedení činnosti |
| **Zájezd** | § 2521—2549 | Cestovní kancelář |

**Klíčové změny oproti starému OZ**:
- **Jednotná úprava díla** — sjednoceny obchodní a občanské dílo;
- **Licenční smlouva** v OZ (dříve roztříštěná v zákoně o autorském právu, patentovém zákoně atd.);
- **Smlouva o péči o zdraví** — **nová smluvní typologie** (dříve nesmluvní zdravotní vztah);
- **Smlouva o účtu** — sjednoceno B2B a B2C; specifická úprava v zákoně o platebním styku č. 370/2017 Sb.
...
- **Výhradní** (*exklusivní*): poskytovatel **nesmí** poskytnout jinou licenci ani sám užívat;
- **Nevýhradní** (*běžná*): poskytovatel může poskytnout i jiným.

**Při nejasnosti**: presumpce **nevýhradnosti** (§ 2361).
...
- **Vlastnictví přechází** na vydlužitele;
...
- **Bez ujednání**: u peněžité zápůjčky se má za to, že je **úplatná** (úročená) **mezi podnikateli**;
- U **neobchodní zápůjčky**: presumpce **bezúplatnosti** (přátelská půjčka).
...
**Úvěr** (*Kredit*) = smlouva **typicky obchodní/bankovní**:
- Rozdíl od zápůjčky:
...
- **Provize** za poskytnutí (typicky 0,5—2 % z částky).

**§ 2397 — Úroky**:
- Smluvní (typicky fixní nebo proměnlivá sazba);
- Smluvní pokuta za prodlení vrácení.

**§ 2398 — Odstoupení**:
- **Úvěrovaný** může vrátit dříve;
- **Úvěrující** může odstoupit při zhoršení poměrů úvěrovaného.

**§ 2399—2400 — Specifické úvěry**:
...
**§ 2405 — Odměna**:
- Smluvní;
- Bez ujednání: presumpce **bezúplatnosti** mezi nepodnikateli;
- Mezi podnikateli: **obvyklá odměna**.

**§ 2406 — Vrácení**: kdykoli na požádání uschovatele.
...
**Návazné předpisy**:
- **Zákon č. 370/2017 Sb. o platebním styku** — detailní úprava;
- **Zákon č. 21/1992 Sb. o bankách** — bankovní právo;
- **PSD2** (sm. 2015/2366) — payment services, otevřené bankovnictví;
- **AML zákon č. 253/2008 Sb.** — KYC, AML opatření.

**§ 2667—2670 — Provozní pravidla**:
- **Pohyby na účtu** — banka eviduje;
- **Výpisy** — minimálně 1× měsíčně;
- **Reklamace** — promlčecí lhůta dle § 2675.
...
- **Příkazce** (kupující);
- **Výstavce** (banka kupujícího);
- **Oprávněný** (prodávající);
- **Předmět**: platba **proti předložení dokumentů** (typicky přepravní list, faktura, pojistka).
...
**Příkaz** (*mandatum*) — **smlouva o obstarání záležitosti pro jiného**:
- **Příkazce** (*mandant*) — zadává úkol;
- **Příkazník** (*mandatarius*) — provádí.
...
**§ 2434 — Pečlivost** s péčí řádného hospodáře.
...
- **Zájemce** = budoucí smluvní strana;
- **Třetí osoba** = druhá smluvní strana.

**Klíčové**: zprostředkovatel **neuzavírá smlouvu** za zájemce, **jen vyhledává**.
...
- **Splatnost**: typicky **při uzavření zprostředkované smlouvy**;
- **Nárok i bez uzavření** — pokud uzavření zmařil zájemce (§ 2450).

**§ 2452 — Výhradní zprostředkování**:
...
- Smlouva se třetí osobou vzniká **mezi komisionářem a třetí osobou**;
- Komisionář **postoupí výsledek** komitentovi.
...
**§ 2457 — Provize** — smluvní (obvykle % z hodnoty obchodu);

**§ 2460 — Limitní ceny** — komisionář dodrží spodní/horní limit ujednaný s komitentem.
...
**Zasílatelská smlouva** (*Spedition*) — **obstarání přepravy**:
- **Zasílatel** (*Spediteur*) — obstarává přepravu zboží;
- **Příkazce** = ten, jehož zboží se přepravuje;
- **Dopravce** = třetí osoba (vykonává fyzicky přepravu).
...
**§ 2491—2493 — Konkurenční doložka** po skončení:
- **Maximálně 2 roky**;
- **Územně a věcně omezená**;
- **Přiměřená kompenzace** zástupci.

**§ 2497 — Odměna za získané obchody** po skončení vztahu (= "trail commission").

---

## Smlouva o péči o zdraví (§ 2636—2651)
...
**§ 2639 — Informovaný souhlas** (*informed consent*):
- Pacient musí být informován o stavu, navrhovaném výkonu, alternativách, rizicích;
- Souhlas **dobrovolný a po informování**.

**§ 2644 — Záznamy** zdravotní dokumentace.

**§ 2645 — Mlčenlivost** (lékařské tajemství).
...
- Spec. **újma za smrt** v rámci medicínské odpovědnosti (§ 2959).
...
- **Objednatel** (*Besteller*) — převezme + zaplatí;
- **Předmět**: **výsledek činnosti** (rozdíl od příkazu — tam činnost samotná).
...
**§ 2590 — Cena ujednaná**:
- Pevně **rozpočtem**;
- **Odhadem** (možné navýšení do 10—15 %);
- **Bez ujednání** = obvyklá cena.
...
**§ 2600 — Materiál**:
- Pokud zhotovitel dodává → odpovídá za vady materiálu;
...
- Oprava (přednostně);
- Nové zhotovení (u věcí);
- Sleva z ceny;
- Odstoupení (při podstatném porušení).

**§ 2629—2630 — Stavební dílo**:
...
**§ 2525 — Informační povinnost** pořadatele před uzavřením smlouvy.

**§ 2526—2528 — Změny ceny**:
- Maximum **8 % navýšení** ceny po uzavření;
- Pouze z důvodu **změn paliva, daní, kurzu měn**.

**§ 2531 — Odstoupení zákazníka**:
- **14 dnů před odjezdem** — **bez storno poplatku** (lze ujednat jinak);
- **Mimořádné okolnosti v destinaci** → bez storna kdykoli.

**§ 2536 — Insolvence pořadatele**:
- **Povinné pojištění** záruky pro případ úpadku (zákon č. 159/1999 Sb. o cestovním ruchu);
- Repatriace zákazníků na náklady pojištění.
...
- Klasický příklad: **odvrácení škody** (např. uhasit požár u souseda v jeho nepřítomnosti).
...
- **Autorský zákon č. 121/2000 Sb.** — licence k autorským dílům;
- **Zákon o vynálezech a zlepšovacích návrzích č. 527/1990 Sb.** — patenty;
- **Zákon o ochranných známkách č. 441/2003 Sb.** — licence známky;
- **Zákon o spotřebitelském úvěru č. 257/2016 Sb.** — úvěry spotřebitelům;
- **Zákon o platebním styku č. 370/2017 Sb.** — bankovní účty, převody;
- **Zákon o bankách č. 21/1992 Sb.** — bankovní právo;
- **Zákon č. 372/2011 Sb. o zdravotních službách** — péče o zdraví;
- **Zákon č. 159/1999 Sb. o cestovním ruchu** — zájezd, pojištění;
- **Zákon o zaměstnancích č. 262/2006 Sb.** — dílo a vztah k pracovnímu poměru;
- **UCP 600 ICC** — akreditiv;
- **PSD2 sm. 2015/2366** — platební služby;
- **PTD sm. 2015/2302** — souborné cestovní služby.
...
### Licence
- **Definice** — § 2358;
- **Výhradní × nevýhradní** — § 2359 (presumpce nevýhradnosti);
- **Podlicence** — § 2364 (souhlas povinný);
- **Úplatnost** — § 2367 (presumpce úplatnosti).

### Finanční smlouvy
- **Zápůjčka** — § 2390 (zastupitelná věc, vlastnictví přechází);
- **Úvěr** — § 2395 (rámec + úroky vždy);
- **Smlouva o účtu** — § 2662 (bankovní účet);
- **Akreditiv** — § 2682 (dokumentární);

### Úschova
- **Definice** — § 2402;
- **Skladování** — § 2415 (podnikatelské, vždy úplatné);

### Příkazní typy
- **Příkaz** — § 2430 (osobní výkon, pokyny);
- **Zprostředkování** — § 2445 (provize při uzavření);
- **Komise** — § 2455 (vlastním jménem na účet);
- **Obchodní zastoupení** — § 2483 (trvalý vztah, soustavná činnost).

### Péče o zdraví
- **Definice** — § 2636 (nový smluvní typ);
- **Lege artis** — § 2638;
- **Informovaný souhlas** — § 2639;
- **Mlčenlivost** — § 2645.

### Dílo
- **Definice** — § 2586 (výsledek činnosti);
- **Cena** — § 2590 (rozpočet/odhad/obvyklá);
- **Předání** — § 2607;
- **Stavební dílo** — § 2629 (záruka 5 let, solidární ručení subdodavatelů).

### Zájezd
- **Definice** — § 2521 (≥ 2 cestovní služby);
- **Změna ceny max. 8 %** — § 2526;
- **Pojištění proti insolvenci** pořadatele — povinné.

### Jednatelství bez příkazu
- **Definice** — § 3006 (odvrácení škody bez pověření);
- **Nárok na náklady** — § 3007.

---

> **Poznámka k judikatuře a doktríně**:
> - Hulmák, M. a kol.: *Občanský zákoník VI. Závazkové právo. Zvláštní část.* C. H. Beck — vícedílná řada;
> - Polčák, R.: *Internetové právo.* C. H. Beck — licence v IT;
> - Šustek, P., Holčapek, T.: *Zdravotnické právo.* Wolters Kluwer — péče o zdraví;
> - Marek, K.: *Smluvní obchodní právo.* C. H. Beck — obchodní typy;
> - **NS sp. zn. 23 Cdo 2778/2018** — k licenční smlouvě a podlicencím;
> - **NS sp. zn. 23 Cdo 4267/2019** — k smlouvě o péči o zdraví, lege artis;
> - **NS sp. zn. 23 Cdo 4847/2018** — k vadám díla u staveb (§ 2629);
> - **SDEU C-200/19 *INA-Industria*** — k zájezdu po PTD směrnici;
> - **ÚS sp. zn. III. ÚS 2123/22** — k informovanému souhlasu a odpovědnosti lékaře.
